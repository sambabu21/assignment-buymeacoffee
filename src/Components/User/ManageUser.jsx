        ...
        <div className=" md:px-[132px] flex flex-col justify-center items-center">
            <div className="flex w-full justify-between items-center mt-10">
                <motion.h1 
                    ...
                    className="pl-8 md:pl-0 font-medium md:text-[24px]">Manage creators</motion.h1>
                <motion.button 
                    initial={{y:50,opacity:0}}
                    animate={{y:0,opacity:1}}
                    transition={{duration:1,delay:0.5}}
                    className="mr-8 md:mr-0 p-2 md:p-0 md:w-[185px] md:h-[40px] bg-[#9B62E0] rounded-[20px] text-white font-medium md:text-[16px] text-[12px]" onClick={()=>{setOpen(true)}}>+ Add a new creator</motion.button>
            </div>
            {
                isLoading?<Loader /> :
                <>
