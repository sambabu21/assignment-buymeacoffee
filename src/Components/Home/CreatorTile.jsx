export default function CreatorTile({ name,status,gender }){
    ...
    return(
        <div className="min-w-[268px] w-full max-w-[268px] h-[360px] flex flex-col justify-end items-center gap-4 relative hover:border hover:border-gray-200 ">
            <img src={imageUrl} className="absolute w-full h-full object-cover -z-10 "/>
            <h1 className="text-white font-black text-[28px] pb-5 text-center">{name}</h1>
