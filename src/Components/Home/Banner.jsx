...
export default function Banner(){
    return (
        <div className="w-full flex flex-col items-center relative overflow-hidden">
            <h1 className="text-[#222222] font-semibold text-4xl md:text-6xl text-center leading-[50px] md:leading-[70px] mt-14">Stay close to your<br></br><span className="text-[#9B62E0]"> favorite people.</span></h1>
            <div className="mt-14 md:w-[600px] md:h-[80px]  flex rounded-full items-center justify-between relative">
