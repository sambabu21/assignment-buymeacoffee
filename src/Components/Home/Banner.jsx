    ...
    return (
        <div className="w-full flex flex-col items-center relative overflow-hidden">
            ...
            <div className="mt-14 w-[600px] h-[80px]  flex rounded-full items-center justify-between relative">
                <input placeholder="Enter your phone number" type="phone" className="flex text-md ml-10 rounded-full w-1/2 m-2"/>
                <button className="w-[167px] h-[67px] bg-[#222222] text-white font-semibold rounded-full mr-2">Get started</button>
                <div className="absolute w-full h-full rounded-full border inset-0 shadow-[0px_4px_20px_0px_#00000009] cursor-pointer"></div>
            </div>
